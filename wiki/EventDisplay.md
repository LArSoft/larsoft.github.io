...
All options can be specified from the [source:trunk/EventDisplay/evdservices.fcl](https://cdcvs.fnal.gov/redmine/projects/larsoft/repository/entry/trunk/EventDisplay/evdservices.fcl) file or they can be edited at run time using the Job-\>Edit Config menu. Some of the more popular ones are
