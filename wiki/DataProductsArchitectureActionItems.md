...
<sup>1</sup> `LArSoft` Data Architecture Meeting, [December 8, 2014](https://indico.fnal.gov/conferenceDisplay.py?confId=9173)

<sup>2</sup> Discussion, including Erica Snider and Gianluca Petrillo, on December 11, 2014. Saturation is inherently per-sample and flagging the whole raw digit where saturation happened is not informative.

<sup>3</sup> Latest discussion: MicroBooNE IIT workshop, January 7th, 2015.

<sup>4</sup> Proposal by MicroBooNE on January 7th, 2015 and acknowledgement by LBNF on January 28th, 2015
