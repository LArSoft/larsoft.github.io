...
-   An understanding of the terms *[image](Developing_LArSoft_on_Unsupported_Operating_Systems_with_Docker#The-Image)*, *\[\[Developing_LArSoft_on_Unsupported_Operating_Systems_with_Docker#The-Container\|container\]\]* and, *\[\[Developing_LArSoft_on_Unsupported_Operating_Systems_with_Docker#The-Volume\|volume\]\]* is necessary for productive use of this approach and adaption to one's own preferred workflow and environment.
