...
|20210204|`v09_16_00`|[root v6_22_06a typo](#root-v6_22_06a-typo)||
|20210114|`v09_13_00`|[larrecodnn new directory structure](#larrecodnn-new-directory-structure)||
|20210107|`v09_12_00`|[Geometry configuration check](#Geometry-configuration-check)|[redmine issue 24328](https://cdcvs.fnal.gov/redmine/issues/24328)|
|20200819|`v09_00_00`|[larsoft v09_00_00](#larsoft-v09_00_00)||
|20191113|`v08_36_00`|[Update to nutools v3_05_00 with nuevdb](#Update-to-nutools-v3_05_00-with-nuevdb)||
|20191113|`v08_36_00`|[Using boost v1_70_0](#Using-boost-v1_70_0)||
|20191113|`v08_36_00`|[update to art v3_03_01](#Update-to-art-v3_03_01)||
|20191111|`v08_35_01`|[Lengthen raw::RawDigit fSamples](#Lengthen-rawRawDigit-fSamples)||
|20191023|`v08_33_00`|[Removal of Calorimetry hard-coded values](#Removal-of-Calorimetry-hard-coded-values)|[redmine issue 23457](https://cdcvs.fnal.gov/redmine/issues/23457)|
|20190820|`v08_31_00`|[artdaq_core calls clock_gettime](#artdaq_core-calls-clock_gettime)||
|20190820|`v08_31_00`|[macOS missing TGX11](#macOS-missing-TGX11)||
|20190820|`v08_31_00`|[root IO rules](#root-IO-rules)|[redmine issue 23013](https://cdcvs.fnal.gov/redmine/issues/23013)|
|20190814|`v08_28_01`|[code cleanup](#code-cleanup)||
|20190809|`v08_28_00`|[genie v3_00_06](#genie-v3_00_06)||
|20190725|`v08_27_00`|[nutools v3_02_00](#nutools-v3_02_00)||
|20190610|`v08_22_00`|[nutools v3_00_00](#nutools-v3_00_00)||
...
**More information**: [larcore PR 6](https://github.com/LArSoft/larcore/pull/6), [redmine issue 24328](https://cdcvs.fnal.gov/redmine/issues/24328), and [Geometry configuration check breaking change documentation](Geometry_configuration_check_breaking_change_documentation)
...
**Motivation**: hard-coded values conflict with ICARUS detector (see issue [redmine issue 23457](https://cdcvs.fnal.gov/redmine/issues/23457))
...
-   With root v6_16_00, I/O rules were broken. This is a problem when reading certain old data files (see [redmine issue 23013](https://cdcvs.fnal.gov/redmine/issues/23013)).
-   A working fix for the problem is available in root v6_18_04.
-   Certain I/O rules involving Double32_t must be removed from classes_def.xml files if they exist. This has been done for larsoft v08_31_00. Please see [redmine issue 23013](https://cdcvs.fnal.gov/redmine/issues/23013) for more information.
