...
-   With root v6_16_00, I/O rules were broken. This is a problem when reading certain old data files (see [\#23013](/redmine/issues/23013 "Bug: Unable to read recob::Vertex position information (Closed)")).
-   A working fix for the problem is available in root v6_18_04.
-   Certain I/O rules involving Double32_t must be removed from classes_def.xml files if they exist. This has been done for larsoft v08_31_00. Please see [\#23013](/redmine/issues/23013 "Bug: Unable to read recob::Vertex position information (Closed)") for more information.
