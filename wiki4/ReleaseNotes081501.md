...
-   2012-07-27 Brian Rebel : add GNUmakefile to build the unit-test subdirectory, add [kirby@fnal.gov](mailto:kirby@fnal.gov) to the email list for the unit test run, other changes to hopefully make the running of the nightly build more reliable
