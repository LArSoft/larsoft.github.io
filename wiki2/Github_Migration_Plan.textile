...
h3. Change the Redmine repos post-commit-hook script to only allow pushes to branches named feature/* (-Lynn consulting with MarcM- Kyle)
...
h3.  Cut mrb v3_05_00 and install it on cvmfs (Lynn)
...
h3. Remove phrases with testing from wiki pages
