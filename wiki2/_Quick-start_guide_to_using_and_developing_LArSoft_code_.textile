...
h3. Run non-DUNE or non-uBoonE jobs using only a frozen LArSoft release
...
h2. To build experiment-specific code for DUNE or uBooNE against an existing LArSoft release

h3. Build uboonecode or dunetpc
...
* <pre>setup <uboonecode | dunetpc> <version> -q <qualifiers> </pre> 
...
We encourage users to [[LArSoft_cvmfs_page| install and use a cvmfs client ]] instead of installing the binary distribution wherever possible.
