...
h1. Executing the pull request approval workflow
...
h3. Structured comments on pull requests
...
* See [[Pull_request_comments_that_trigger_CI_actions]] for details of possible comments
...
|_. Step |_. Responsible role |_. Procedure |
