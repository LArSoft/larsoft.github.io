...
h1. Create Tags for a LArSoft Release Build

{{TOC}}


h2. Determine which packages to tag.
...
h2. Check the information for the build files
...
* <pre>cd $MRB_SOURCE
grep ^parent lar*/ups/products_deps</pre>
...
h2. Merge changes with the master branch and tag
...
h2. Copy the build files to SciSoft
