...
h2. Using the NuSonic Triton GPUaaS client in LArSoft
...
h3. Required changes to CMakeLists and headers
...
h3.  Step 3: Sending the inference request
...
h3. Step 4: Retrieving the results
...
h3. In [[GPU as a Service part two|GPU as a Service Part 2]], we explain how to set up an inference model in the GPU server.
