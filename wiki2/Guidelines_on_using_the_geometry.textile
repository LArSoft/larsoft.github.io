...
h1. Guidelines on using the geometry

Detailed information is available on the [[Geometry Package]] and at http://larsoft.org/important-concepts-in-larsoft/geometry/
...
** there is not such a thing as *the* TPC, but there is _a_ TPC
...
** don&#39;t assume the wire pitch is the same on all planes (currently all wires on the _same_ wire plane should have the same pitch, barred bugs)
