...
h1. Removing old feature branches
...
* Using the script and lists [[Removing_old_feature_branches#Identifying-branches-that-can-be-removed|below]], identify branches which have been merged.
...
h2.  Identifying branches that can be removed.
