...
RESOLVED: [[Migration_to_root_6#TFormula-bug-on-missing-parameter-in-expression]]

h3. To reproduce the problem on woof by running the CI tests:
...
h3. run the problematic test by hand:
