...
h2(count). Table of recent changes

|_. Date   |_. Version/commit |_. Description         |_. Issue |
| 20210921 | @v09_31_00@ | [[Breaking_Changes#mrb-5|mrb 5]] | |
| 20210407 | @v09_21_00@ | [[Breaking_Changes#Refactor-EventWeight-interface-to-GENIE-v3|Refactor EventWeight interface to GENIE v3]] | |
| 20210204 | @v09_16_00@ | [[Breaking_Changes#root-v6_22_06a-typo|root v6_22_06a typo]] |  |
| 20210114 | @v09_13_00@ | [[Breaking_Changes#larrecodnn-new-directory-structure|larrecodnn new directory structure]] | |
| 20210107 | @v09_12_00@ | [[Breaking_Changes#Geometry-configuration-check|Geometry configuration check]] | #24328 |
| 20200819 | @v09_00_00@ | [[Breaking_Changes#larsoft-v09_00_00|larsoft v09_00_00]] | |
| 20191113 | @v08_36_00@ | [[Breaking_Changes#Update-to-nutools-v3_05_00-with-nuevdb|Update to nutools v3_05_00 with nuevdb]] | |
| 20191113 | @v08_36_00@ | [[Breaking_Changes#Using-boost-v1_70_0|Using boost v1_70_0]] | |
| 20191113 | @v08_36_00@ | [[Breaking_Changes#Update-to-art-v3_03_01|update to art v3_03_01]] | |
| 20191111 | @v08_35_01@ | [[Breaking_Changes#Lengthen-rawRawDigit-fSamples|Lengthen raw::RawDigit fSamples]]   |   |
| 20191023 | @v08_33_00@ | [[Breaking_Changes#Removal-of-Calorimetry-hard-coded-values|Removal of Calorimetry hard-coded values]] | #23457  |
| 20190820 | @v08_31_00@ | [[Breaking_Changes#artdaq_core-calls-clock_gettime|artdaq_core calls clock_gettime]]  |  |
| 20190820 | @v08_31_00@ | [[Breaking_Changes#macOS-missing-TGX11|macOS missing TGX11]]  |  |
| 20190820 | @v08_31_00@ | [[Breaking_Changes#root-IO-rules|root IO rules]]  | #23013 |
| 20190814 | @v08_28_01@ | [[Breaking_Changes#code-cleanup|code cleanup]]  |  |
| 20190809 | @v08_28_00@ | [[Breaking_Changes#genie-v3_00_06|genie v3_00_06]]  |  |
| 20190725 | @v08_27_00@ | [[Breaking_Changes#nutools-v3_02_00|nutools v3_02_00]]  |  |
| 20190610 | @v08_22_00@ | [[Breaking_Changes#nutools-v3_00_00|nutools v3_00_00]]  |  |
| 201904xx | @v08_15_00@ | [[Breaking_Changes#New-PhotonVisibilityService-features|New PhotonVisibilityService features]]  |   |
| 2019     |             | [[Update to art v3_02]] | |
| 20181213 | @v08_00_00@ | [[Update from art v2 to art v3]] | |
| 20181129 | @v07_12_00@ | [[Breaking_Changes#Remove-deprecated-members-and-methods-from-recobTrack|Remove deprecated members and methods from recob::Track]] | |

h2(count). Changes for larsoft v06_xx_yy and previous

For ease of navigation, older breaking changes have been moved to [[Breaking Changes prior to v07_00_00]]

h2(count). mrb 5

*When was committed*:  [[ReleaseNotes093100|v09_31_00]]
...
h2(count). Refactor EventWeight interface to GENIE v3

*When was committed*:  [[ReleaseNotes092100|v09_21_00]]
...
h2(count). root v6_22_06a typo

*When was committed*:  [[ReleaseNotes091600|v09_16_00]]
...
h2(count). larrecodnn new directory structure

*When was committed*:  [[ReleaseNotes091300|v09_13_00]]
...
h2(count). Geometry configuration check

*When was committed*:  [[ReleaseNotes091200|v09_12_00]]
...
*More information*: "larcore PR 6":https://github.com/LArSoft/larcore/pull/6, #24328, and [[Geometry configuration check breaking change documentation]]
*Contact*:  "Gianluca Petrillo":mailto:petrillo@slac.stanford.edu

h2(count). larsoft v09_00_00

*When was committed*:  [[ReleaseNotes090000|v09_00_00]]
*Contact*: "The Scisoft Team":mailto:scisoft-team@fnal.gov

h2(count). Update to nutools v3_05_00 with nuevdb

*When was committed*:  [[ReleaseNotes083600|v08_36_00]]
*Motivation*: nutools EventDisplayBase is now in nuevdb 
*Affects*: user or experiment code
*Failure when not fixed*: Compilation or linking errors.
...
h2(count). Update to art v3_03_01

*When was committed*:  [[ReleaseNotes083600|v08_36_00]]
*Motivation*: Move from art v3_02 to art v3_03
*Affects*: user or experiment code
*Failure when not fixed*: Compilation or linking errors.
*Fix*: see the [[art:Series_303|art series 3.03]] page for art breaking changes 
*Contact*: "The Scisoft Team":mailto:scisoft-team@fnal.gov

h2(count). Lengthen raw::RawDigit fSamples 

*When was committed*:  [[ReleaseNotes083501|v08_35_01]]
...
h2(count). Removal of Calorimetry hard-coded values

*When was committed*:  [[ReleaseNotes083300|v08_33_00]]
...
h2(count). artdaq_core calls clock_gettime

*When was committed*:  [[ReleaseNotes083100|v08_31_00]]
...
*When was committed*:  [[ReleaseNotes082801|v08_28_01]]
...
h2(count). genie v3_00_06

*When was committed*:  [[ReleaseNotes082800|v08_28_00]]
...
h2(count). nutools v3_02_00

*When was committed*:  [[ReleaseNotes082700|v08_27_00]]
...
h2(count). nutools v3_00_00

*When was committed*:  [[ReleaseNotes082200|v08_22_00]]
...
h2(count). New PhotonVisibilityService features

*When was committed*:  [[ReleaseNotes081500|v08_15_00]]
...
*Failure when not fixed*: Compilation or linking errors.
*Fix*: Several different cases are possible. Please see the _additional material_ slides in "the presentation of the new feature":https://indico.fnal.gov/event/20409/contribution/2/material/slides/0.pdf at "LArSoft coordination meeting on April 9, 2019":https://indico.fnal.gov/event/20409 .
*Contact*: "Gianluca Petrillo":mailto:petrillo@slac.stanford.edu

h2(count). Remove deprecated members and methods from recob::Track

*When was committed*:  [[ReleaseNotes071200|v07_12_00]]
