...
h3. An [[pull request testing and approval workflow|overview of the pull request testing and approval process]]

h3. For LArSoft users and developers:  how to check out repositories, requirements and steps to submit changes, move existing code
...
h3. For Level 1 and Level 2 managers / approvers:  procedures for managing and approving pull requests
...
h3. For people who maintain the approval workflow 
...
h3. For new experiments / projects seeking to customize and use the pull request approval workflow system

* [[SetupCMSbotScriptsYourOrg|Setting the LArSoft fork of CMSbot for your organization/repo]]

h3. General references on using GitHub (not LArSoft specific)
...
h2. Working notes (mostly archival)
