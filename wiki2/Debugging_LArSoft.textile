...
h1. Debugging LArSoft code

{{toc}}

h2. RogueWave TotalView
...
h3. Targeting a part of the code

Execution can be stopped at any point by the use of breakpoints. TotalView has them as a category of _action points_, actions triggered by some "event" in the program. A break point reacts to the event "starting to execute at that address" with a "Halt" action.
...
h2. Instructions for "totalview":http://www.roguewave.com/support/product-documentation/totalview-family.aspx#totalview GUI debugging
