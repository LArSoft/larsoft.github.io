...
h1. Installation procedures

Each release of LArSoft has a release page on "SciSoft":http://scisoft.fnal.gov/scisoft/bundles/larsoft/
* <pre>http://scisoft.fnal.gov/scisoft/bundles/larsoft/<version>/larsoft-<version>.html</pre>

h2.  Installing a binary distribution
...
Arguments:
  ...
  build-spec       debug or prof.</pre>
> * For instance: <pre>./pullProducts /grid/fermiapp/products/larsoft slf6 larsoft-v04_08_00 s8-e7 prof</pre>
