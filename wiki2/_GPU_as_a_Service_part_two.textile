...
h1. GPU as a Service Part 2

h1. Setting up the model on a Triton inference server
...
h3.  In [[GPU as a Service part three|GPU as a Service Part 3]], we describe how to test the client and model configuration locally, or via a dedicated test server at Fermilab.
