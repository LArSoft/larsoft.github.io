...
h1. LArSoft responsiblities for patch releases

h2(count). Permissions

h3(count). Manager permissions for larsoft redmine projects
...
h2(count).  Initial setup - one time steps for each set of patch releases
