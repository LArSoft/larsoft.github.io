...
h1. ProtoDUNE and DUNE Far Detector simulation and reconstruction workflows (v06 57 00)

h2. A typical workflow for detector simulation and reconstruction (gen-g4-detsim-reco-ana)
...
h2. Profiling memory and CPU performance

h3. IgProf (http://igprof.org/)
...
h3. HPCToolkit (http://hpctoolkit.org/index.html)
...
</pre> Replace hpcrun PAPI options for other hardware counters measurement as shown below 
...
h3. Open|Speedshop (https://openspeedshop.org/)
...
h3. Support: contact syjun@fnal.gov 
