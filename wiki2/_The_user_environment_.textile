...
The versions and qualifiers available can be obtained by looking at the [[LArSoft_release_list#releases|table of releases on the LArSoft wiki]], or by using the following command:
<pre>
ups list -aK+ larsoft
</pre>
...
(See [[cet-is-public:AboutQualifiers|the explanation of product qualifiers page]] for more information on the qualifiers used in art products.)
...
or by looking at the [[LArSoft_release_list|table of releases on the LArSoft wiki]].
...
h2. Creating a new product in your working area: @mrb newProduct@
