...
h1. From old ROOT vectors and matrix (@TVector3@, @TMatrixT@) to ROOT GenVector and SMatrix
...
|/5. "GenVector":https://root.cern.ch/doc/master/group__GenVector.html | "@ROOT::Math::PositionVector3D@":https://root.cern.ch/doc/master/classROOT_1_1Math_1_1PositionVector3D.html | "@geo::Point_t@":http://nusoft.fnal.gov/larsoft/doxsvn/html/namespacegeo.html#a8f50958e1ae782539f468fe82b56e680 |
...
|/4. ROOT                                                                                                          | "@TVector2@":https://root.cern.ch/doc/master/classTVector2.html |
...
h2. @TVector3@ vs. @ROOT::Math::DisplacementVector@ and @ROOT::Math::PositionVector@
...
h3. Creation of a new point/vector
...
h3. Access and increment of components
...
h3. Access to components by index
