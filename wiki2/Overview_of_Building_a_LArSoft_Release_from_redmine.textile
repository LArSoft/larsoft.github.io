...
h1. Overview of Building a LArSoft Release from redmine
...
h2(count).  Merge any feature branches

We use the [[FutureChanges|future changes]] page to collect a list of feature branches that are meant to be part of the next release.  This helps make sure we don&#39;t forget anything.
...
h2(count).  Build for all 4 compilers
